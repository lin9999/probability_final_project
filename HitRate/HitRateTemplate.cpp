...
int choosBeShot(map<int, double> players, vector<player> hitRateRank, ITER shooter, double hitRateSum, bool isMe) {
	...
	if (isMe) {
		//return shootRandom(hitRateRank, shooter);
		//return shootMost(hitRateRank, shooter);
		//return shootMid(hitRateRank, shooter);
		//return shootLowest(hitRateRank, shooter);
		//return shootHighest(hitRateRank, shooter);
		//return shootByTurnsOut(hitRateRank, shooter);
